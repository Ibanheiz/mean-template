// Karma configuration
// Generated on Thu Jun 04 2015 17:27:27 GMT-0300 (BRT)
...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      './front/components/angular-sanitize/angular-sanitize.js',
      './front/components/angular-animate/angular-animate.js',
      './front/components/angular-animate/angular-animate.js',
      './front/js/modules/**/*.js',
      './front/js/*.js',
      './front/test/**/*Spec.js'

!function(e){"use strict";e.module("app",["app.controllers","app.directives","app.filters","app.services","ngSanitize","ngRoute","ngResource","ngAnimate"]).config(["$routeProvider","$locationProvider",function(e,n){var t=["$q","$http","$location",function(e,n,t){var r=e.defer();return n.get("/loggedin").success(function(e){"0"!==e?r.resolve():(r.reject(),t.url("/mean-seed/login"))}),r.promise}];e.when("/mean-seed/login",{templateUrl:"expose/main/login",controller:"LoginController"}).when("/mean-seed/client",{templateUrl:"expose/client/list",controller:"ClientListController",resolve:{loggedin:t}}).when("/mean-seed/client/create",{templateUrl:"expose/client/save",controller:"ClientCreateController",resolve:{loggedin:t}}).when("/mean-seed/client/:id/edit",{templateUrl:"expose/client/save",controller:"ClientEditController",resolve:{loggedin:t}}).when("/mean-seed/client/:id/remove",{templateUrl:"expose/client/edit",controller:"ClientRemoveController",resolve:{loggedin:t}}).when("/mean-seed/user",{templateUrl:"expose/user/list",controller:"UserController",resolve:{loggedin:t}}).when("/mean-seed/404",{templateUrl:"expose/main/404",controller:"UserController",resolve:{loggedin:t}}).otherwise({redirectTo:"/mean-seed/404"}),n.html5Mode(!0)}]).config(["$provide","$httpProvider",function(e,n){e.factory("authenticateInterceptor",["$q","$location",function(e,n){return{response:function(e){return e},responseError:function(t){return 401===t.status&&n.url("/mean-seed/login"),e.reject(t)}}}]),n.interceptors.push("authenticateInterceptor")}])}(angular);
...
!function(o){"use strict";function n(o){o.mensagem="Faça login meu jovem"}o.module("app.modules.Login.controllers",[]).controller("LoginController",n),n.$inject=["$scope","$http"]}(angular);

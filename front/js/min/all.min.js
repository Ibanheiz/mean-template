!function(e){"use strict";var l=["$q","$http","$location",function(e,l,n){var o=e.defer();return l.get("/api/login/loggedin").success(function(e){"0"!==e?o.resolve():(o.reject(),n.url("/mean-seed/login"))}),o.promise}],n=["$q","$http","$location",function(e,l,n){var o=e.defer();return l.get("/api/login/loggedin").success(function(e){"0"!==e?(o.reject(),n.url("/mean-seed/client")):o.resolve()}),o.promise}];e.module("app",["app.controllers","app.directives","app.filters","app.services","ngSanitize","ngRoute","ngResource","ngAnimate"]).config(["$routeProvider","$locationProvider",function(e,o){e.when("/mean-seed/login",{templateUrl:"expose/login/login",controller:"LoginController",resolve:{loggedin:n}}).when("/mean-seed/signup",{templateUrl:"expose/login/signup",controller:"SignupController",resolve:{loggedin:n}}).when("/mean-seed/client",{templateUrl:"expose/client/list",controller:"ClientListController",resolve:{loggedin:l}}).when("/mean-seed/client/create",{templateUrl:"expose/client/save",controller:"ClientCreateController",resolve:{loggedin:l}}).when("/mean-seed/client/:id/edit",{templateUrl:"expose/client/save",controller:"ClientEditController",resolve:{loggedin:l}}).when("/mean-seed/client/:id/remove",{templateUrl:"expose/client/edit",controller:"ClientRemoveController",resolve:{loggedin:l}}).when("/mean-seed/user",{templateUrl:"expose/user/list",controller:"UserController",resolve:{loggedin:l}}).when("/mean-seed/404",{templateUrl:"expose/main/404",controller:"UserController",resolve:{loggedin:l}}).otherwise({redirectTo:"/mean-seed/404"}),o.html5Mode(!0)}])}(angular);

!function(e){"use strict";function o(e,o,t){var l=e.defer();return o.get("/api/login/loggedin").success(function(e){t(l,e)}),l.promise}function t(e,o,t){e.when(t.getLogin,{templateUrl:"expose/login/login",controller:"LoginController",resolve:{loggedin:l.checkLoggedOut}}).when(t.getSignup,{templateUrl:"expose/login/signup",controller:"SignupController",resolve:{loggedin:l.checkLoggedOut}}).when(t.getHome,{templateUrl:"expose/client/list",controller:"ClientListController",resolve:{loggedin:l.checkLoggedin}}).when(t.getCreateClient,{templateUrl:"expose/client/save",controller:"ClientCreateController",resolve:{loggedin:l.checkLoggedin}}).when(t.getEditClient,{templateUrl:"expose/client/save",controller:"ClientEditController",resolve:{loggedin:l.checkLoggedin}}).when(t.getRemoveClient,{templateUrl:"expose/client/remove",controller:"ClientRemoveController",resolve:{loggedin:l.checkLoggedin}}).when(t.getUser,{templateUrl:"expose/user/list",controller:"UserController",resolve:{loggedin:l.checkLoggedin}}).when(t.get404,{templateUrl:"expose/main/404",controller:"UserController",resolve:{loggedin:l.checkLoggedin}}).otherwise({redirectTo:t.get404}),o.html5Mode(!0)}var l={checkLoggedin:["$q","$http","$location","systemUri",function(e,t,l,n){o(e,t,function(e,o){"0"!==o?e.resolve():(e.reject(),l.url(n.getLogin()))})}],checkLoggedOut:["$q","$http","$location","systemUri",function(e,t,l,n){o(e,t,function(e,o){"0"!==o?(e.reject(),l.url(n.getHome())):e.resolve()})}]};t.$inject=["$routeProvider","$locationProvider","systemUriConfig"],e.module("app",["app.controllers","app.directives","app.filters","app.services","app.factorys","app.constants","ngSanitize","ngRoute","ngResource","ngAnimate"]).config(t)}(angular);

!function(e){"use strict";e.module("app",["app.controllers","app.directives","app.filters","app.services","ngSanitize","ngRoute","ngResource","ngAnimate"]).config(["$routeProvider","$locationProvider",function(e,l){var n=["$q","$http","$location",function(e,l,n){var o=e.defer();return l.get("/api/login/loggedin").success(function(e){"0"!==e?o.resolve():(o.reject(),n.url("/mean-seed/login"))}),o.promise}];e.when("/mean-seed/login",{templateUrl:"expose/login/login",controller:"LoginController"}).when("/mean-seed/signup",{templateUrl:"expose/login/signup",controller:"SignupController"}).when("/mean-seed/client",{templateUrl:"expose/client/list",controller:"ClientListController",resolve:{loggedin:n}}).when("/mean-seed/client/create",{templateUrl:"expose/client/save",controller:"ClientCreateController",resolve:{loggedin:n}}).when("/mean-seed/client/:id/edit",{templateUrl:"expose/client/save",controller:"ClientEditController",resolve:{loggedin:n}}).when("/mean-seed/client/:id/remove",{templateUrl:"expose/client/edit",controller:"ClientRemoveController",resolve:{loggedin:n}}).when("/mean-seed/user",{templateUrl:"expose/user/list",controller:"UserController",resolve:{loggedin:n}}).when("/mean-seed/404",{templateUrl:"expose/main/404",controller:"UserController",resolve:{loggedin:n}}).otherwise({redirectTo:"/mean-seed/404"}),l.html5Mode(!0)}])}(angular);

!function(e){"use strict";function o(e,o,n){var l=e.defer();return o.get("/api/login/loggedin").success(function(e){n(l,e)}),l.promise}function n(e,o){authenticationProvider.setTeste("locoooo"),console.log(authenticationProvider.$get().teste),e.when("/mean-seed/login",{templateUrl:"expose/login/login",controller:"LoginController",resolve:{loggedin:l.checkLoggedOut}}).when("/mean-seed/signup",{templateUrl:"expose/login/signup",controller:"SignupController",resolve:{loggedin:l.checkLoggedOut}}).when("/mean-seed/client",{templateUrl:"expose/client/list",controller:"ClientListController",resolve:{loggedin:l.checkLoggedin}}).when("/mean-seed/client/create",{templateUrl:"expose/client/save",controller:"ClientCreateController",resolve:{loggedin:l.checkLoggedin}}).when("/mean-seed/client/:id/edit",{templateUrl:"expose/client/save",controller:"ClientEditController",resolve:{loggedin:l.checkLoggedin}}).when("/mean-seed/client/:id/remove",{templateUrl:"expose/client/edit",controller:"ClientRemoveController",resolve:{loggedin:l.checkLoggedin}}).when("/mean-seed/user",{templateUrl:"expose/user/list",controller:"UserController",resolve:{loggedin:l.checkLoggedin}}).when("/mean-seed/404",{templateUrl:"expose/main/404",controller:"UserController",resolve:{loggedin:l.checkLoggedin}}).otherwise({redirectTo:"/mean-seed/404"}),o.html5Mode(!0)}var l={checkLoggedin:["$q","$http","$location",function(e,n,l){o(e,n,function(e,o){"0"!==o?e.resolve():(e.reject(),l.url("/mean-seed/login"))})}],checkLoggedOut:["$q","$http","$location",function(e,n,l){o(e,n,function(e,o){"0"!==o?(e.reject(),l.url("/mean-seed/client")):e.resolve()})}]};n.$inject=["$routeProvider","$locationProvider"],e.module("app",["app.controllers","app.directives","app.filters","app.services","ngSanitize","ngRoute","ngResource","ngAnimate"]).config(n)}(angular);

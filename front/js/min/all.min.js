...
!function(e){"use strict";function t(){return{restrict:"E",scope:{show:"="},replace:!0,transclude:!0,link:function(e,t,i){setTimeout(function(){t.removeAttr("style")},1e3),e.hideModal=function(){e.show=!1}},templateUrl:"partials/template-modal"}}e.module("app.directives",["app.modules.Client.directives"]).directive("modalDialog",t)}(angular);

!function(e){"use strict";function o(e,o,t){var n=e.defer();return o.get("/api/login/loggedin").success(function(e){t(n,e)}),n.promise}function t(e,o,t){e.when(t.getLogin,{templateUrl:"expose/login/login",controller:"LoginController",resolve:{loggedin:l.checkLoggedOut}}).when(t.getSignup,{templateUrl:"expose/login/signup",controller:"SignupController",resolve:{loggedin:l.checkLoggedOut}}).when(t.getHome,{templateUrl:"expose/client/list",controller:"ClientListController",resolve:{loggedin:l.checkLoggedin}}).when(t.getCreateClient,{templateUrl:"expose/client/save",controller:"ClientCreateController",resolve:{loggedin:l.checkLoggedin}}).when(t.getEditClient,{templateUrl:"expose/client/save",controller:"ClientEditController",resolve:{loggedin:l.checkLoggedin}}).when(t.getRemoveClient,{templateUrl:"expose/client/remove",controller:"ClientRemoveController",resolve:{loggedin:l.checkLoggedin}}).when(t.getUser,{templateUrl:"expose/user/list",controller:"UserController",resolve:{loggedin:l.checkLoggedin}}).when(t.get404,{templateUrl:"expose/main/404",controller:"UserController",resolve:{loggedin:l.checkLoggedin}}).otherwise({redirectTo:t.get404}),o.html5Mode(!0)}function n(e,o){e.systemUri=o}var l={checkLoggedin:["$q","$http","$location","systemUri",function(e,t,n,l){o(e,t,function(e,o){"0"!==o?e.resolve():(e.reject(),n.url(l.getLogin()))})}],checkLoggedOut:["$q","$http","$location","systemUri",function(e,t,n,l){o(e,t,function(e,o){"0"!==o?(e.reject(),n.url(l.getHome())):e.resolve()})}]};t.$inject=["$routeProvider","$locationProvider","systemUriConfig"],n.$inject=["$rootScope","systemUri"],e.module("app",["app.controllers","app.directives","app.filters","app.services","app.factorys","app.constants","ngAnimate","ngSanitize","ngRoute","ngResource"]).config(t).run(n)}(angular);
...
!function(o){"use strict";function e(o,e,n,s,r){o.showModal=!1,o.login=function(e){r.login(e).then(function(e){t.cbValidateLogin(e,o,n,s,o.systemUri)},function(e){t.cbError("Erro ao efetuar Login.",e,o)})},o.signout=function(){r.signout().then(function(e){console.log(e),s.url(o.systemUri.getLogin())},function(e){t.cbError("Erro ao efetuar logout.",e,o)})}}function n(o,e,n,s,r){o.showModal=!1,o.createUser=function(e){t.validatePassword(e)?r.create(e).then(function(e){t.cbCreateSucess(e,o,n,s,o.systemUri)},function(e){t.cbError("Erro ao criar o usuário.",e,o)}):(o.message="Senha diferente da confirmação",t.showModal(o,n))}}var t={cbCreateSucess:function(o,e,n,s,r){e.message="Usuário cadastrado com sucesso",e.user={},s.url(r.getHome()),t.showModal(e,n)},cbValidateLogin:function(o,e,n,s,r){console.log(o.data);var a=o.data.user;a?(console.log(a),s.url(r.getHome())):(console.log(o.data.message),e.message=o.data.message,e.user.password=null,t.showModal(e,n))},validatePassword:function(o){return o.confirmPassword===o.password},cbError:function(o,e,n){console.log(e),n.status=o+" "+e.message},showModal:function(o,e){o.showModal=!o.showModal,e(function(){o.showModal=!o.showModal},4e3)}};o.module("app.modules.Login.controllers",[]).controller("LoginController",e).controller("SignupController",n),e.$inject=["$scope","$http","$timeout","$location","LoginService"],n.$inject=["$scope","$http","$timeout","$location","LoginService"]}(angular);
